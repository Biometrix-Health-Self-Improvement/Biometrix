...
public class SleepSettings extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        settingsView = view;
        SettingsAndEntryHelper.setupSwitches(view, SettingsAndEntryHelper.getAllSleepKeysAndRIDs(), true);
        return view;
    }
    ...
    public void onAcceptClick(View v){
        SettingsAndEntryHelper.storeSwitchValues(settingsView, SettingsAndEntryHelper.getAllSleepKeysAndRIDs());
    }
}
